...
<div class="max-w-7xl mx-auto p-9 grid grid-cols-1 md:grid-cols-2 gap-11">
    ...
    <!-- LEFT SIDE IMAGES -->
    <div>
        <img id="mainImage" src="gb8.jpg" class="w-full rounded-xl shadow-lg h-96 object-cover">

        <div class="flex gap-3 mt-4">
            <img onclick="changeImage(this.src)" src="gb.jpg" class="w-20 h-20 rounded-md cursor-pointer border">
            <img onclick="changeImage(this.src)" src="gb8.jpg" class="w-20 h-20 rounded-md cursor-pointer border">
            <img onclick="changeImage(this.src)" src="gb7.jpg" class="w-20 h-20 rounded-md cursor-pointer border">
    ...
    <div>
        <h2 class="text-3xl font-bold">Adjustable multiple Bangles</h2>
        <p class="text-gray-600 mt-2 text-xl font-bold">Premium | Quality</p>

        <p class="text-2xl font-bold text-[#6e510b] mt-3">Rs. 3,200</p>
        ...
        <div class="flex gap-4 mt-6">
            <button onclick="openCartPanel()" class="px-6 py-3 bg-[#6e510b] text-white rounded-lg shadow">
                Add to Cart
            </button>
        ...
        <div class="mt-6">
            ...
            <p class="text-gray-700 mt-2">
                High quality sapphire bangles – perfect for bridal and party wear.
            </p>
        </div>
    </div>
</div>
...
<div id="cartPanel"
    ...
    <img id="cartImage" src="gb8.jpg" class="w-full h-40 object-cover rounded-lg">

    <h3 id="cartName" class="text-xl font-semibold mt-4">Adjustable multiple Bangles</h3>

    <p class="mt-3 text-gray-600"><b>Quantity:</b> <span id="cartQty">1</span></p>

    <p class="text-gray-700 mt-2"><b>Total:</b> Rs. <span id="cartTotal">3200</span></p>
...
<div id="checkoutForm" class="fixed top-0 left-0 w-full h-full bg-black bg-opacity-50 flex items-center justify-center hidden">
    <div class="bg-white p-6 rounded-lg w-96">
        ...
        <form action="bcard2.php" id="orderForm" method="POST">
