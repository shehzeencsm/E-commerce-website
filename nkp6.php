...
<?php endif; ?>
  ...
  <div class="max-w-7xl mx-auto p-9 grid grid-cols-1 md:grid-cols-2 gap-11">
    ...
    <!-- LEFT IMAGES -->
    <div>
      <img id="mainImage" src="nk13.jpg" class="w-full rounded-xl shadow-lg h-96 object-cover">

      <div class="flex gap-3 mt-4">
        <img onclick="changeImage(this.src)" src="nk5.jpg" class="w-20 h-20 rounded-md cursor-pointer border">
        <img onclick="changeImage(this.src)" src="nk4.jpg" class="w-20 h-20 rounded-md cursor-pointer border">
    ...
    <div>
      ...
      <p class="text-gray-600 mt-2 text-2xl font-bold">Delicate Premium Detailing</p>

      <p class="text-2xl font-bold text-[#6e510b] mt-3"> Rs. 100,999</p>
...
<div id="cartPanel"
    ...
    <img id="cartImage" src="nk13.jpg" class="w-full h-40 object-cover rounded-lg">

    <h3 id="cartName" class="text-xl font-semibold mt-4">Sparkling Diamond Shine</h3>
    <p class="text-[#6e510b] font-bold">Delicate Premium Detailing</p>

    <p class="mt-3 text-gray-600"><b>Quantity:</b> <span id="cartQty">1</span></p>

    <p class="text-gray-700 mt-2"><b>Total:</b> Rs. <span id="cartTotal"> 100,999</span></p>

    <p class="mt-4 text-gray-600 font-semibold">More Images:</p>
    <div class="flex gap-3 mt-2">
        <img src="nk5.jpg" class="w-20 h-20 rounded-md border">
...
<div id="checkoutForm" class="fixed top-0 left-0 w-full h-full bg-black bg-opacity-50 flex items-center justify-center hidden">
    <div class="bg-white p-6 rounded-lg w-96">
        ...
        <form action="nkp6.php" id="orderForm" method="POST">
